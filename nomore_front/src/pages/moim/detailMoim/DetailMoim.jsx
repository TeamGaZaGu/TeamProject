        ...
        <>
            <div css={container}>
                <div css={box}>
                    ...
                    <button css={homeButton} onClick={handleOpenModal}>
                        고객센터 문의하기
                    </button>
                </div>
            </div>
            ...
            {isModalOpen && (
                <div css={modalOverlay} onClick={(e) => e.target === e.currentTarget && handleCloseModal()}>
                    <div css={modalContent}>
                        ...
                        <div css={modalFooter}>
                            <button css={cancelButton} onClick={handleCloseModal}>
                                취소
                            </button>
                            <button 
                                css={submitButton} 
